...
namespace PTCwebApi.Methods
{
    public class StoreConnectionMethod
    {
        ...
        public async Task<IEnumerable<dynamic>> PtcGetCurrentPlans(string compID, string toolType, string startDay, string endDay, string wareHouse, string ptcID)
        {
            List<Param> param = new List<Param>() {
                new Param () { ParamName = "I_COMP_ID", ParamType = ParamMeterTypeEnum.STRING, ParamValue = compID },
                ...
                new Param () { ParamName = "I_WH", ParamType = ParamMeterTypeEnum.STRING, ParamValue = wareHouse },
                new Param () { ParamName = "I_PTC_ID", ParamType = ParamMeterTypeEnum.STRING, ParamValue = ptcID },
            };
